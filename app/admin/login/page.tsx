...
export default function LoginPage() {
  ...
  const handleSubmit = async () => {
    ...
    setTimeout(() => {
      ...
      alert('Login functionality ready to connect with your backend!');
      setLoading(false);
    }, 1500);
  };
    ...
    <div className="min-h-screen flex items-center justify-center py-12 px-4" style={{ backgroundColor: '#F6EFE7' }}>
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="text-center">
          <h1 className="text-5xl font-light mb-3" style={{ color: '#3d2817' }}>
            Welcome Back
          </h1>
        ...
        <div className="bg-white shadow-lg p-8" style={{ backgroundColor: '#fffaf4', borderTop: '3px solid #3d2817' }}>
          ...
          <div className="relative my-6">
            <div className="absolute inset-0 flex items-center">
              <div className="w-full border-t" style={{ borderColor: '#e5dcd4' }}></div>
            </div>
            <div className="relative flex justify-center text-xs uppercase">
              <span className="px-4 text-xs" style={{ backgroundColor: '#fffaf4', color: '#b29373' }}>
                Or continue with
              </span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            <button
              type="button"
              className="py-2.5 px-4 border text-sm font-medium flex items-center justify-center gap-2 hover:bg-gray-50 transition-colors"
        ...
        <div className="text-center text-sm">
          <span style={{ color: '#8b6f47' }}>Don't have an account? </span>
          <a 
            href="#" 
        ...
        {/* Footer */}
        <div className="text-center text-xs pt-4" style={{ color: '#b29373' }}>
